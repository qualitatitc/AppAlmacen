...
(function() {
  ...
  async function renderShell() {
    ...
    document.getElementById('app').innerHTML = '<div class="app" id="appShell">'
      ...
      + '<a href="#/inventory/stock" class="nav-item" data-path="/inventory/stock"><span class="nav-item-icon">📋</span> Inventario</a>'
  ...
  var routeTitles = { '/dashboard':'Dashboard', '/products':'Productos', '/locations':'Ubicaciones', '/inventory':'Inventario', '/inventory/entry':'Entrada', '/inventory/exit':'Salida', '/inventory/stock':'Stock', '/inventory/movements':'Movimientos', '/users':'Usuarios', '/map3d':'Mapa 3D' };
